...
type Tab = 'info' | 'manage' | 'style' | 'commands' | 'helper';
type Feature = 'DHCP' | 'DHCP Relay' | 'DHCP Snooping' | 'VLAN' | 'Interface' | 'Link Aggregation' | 'Port Isolation' | 'STP' | 'Routing' | 'VRRP' | 'Wireless' | 'ACL' | 'NAT' | 'SSH' | 'Security' | 'Object Groups' | 'IPsec' | 'HA' | 'GRE VPN' | 'Stacking (IRF)';
