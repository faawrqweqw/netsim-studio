...
type Feature = 'DHCP' | 'VLAN' | 'Interface' | 'Link Aggregation' | 'Port Isolation' | 'STP' | 'Routing' | 'VRRP' | 'Wireless' | 'ACL' | 'NAT' | 'SSH' | 'Security' | 'Object Groups' | 'IPsec' | 'HA' | 'GRE VPN' | 'Stacking (IRF)';
