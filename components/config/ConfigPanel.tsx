...
import CommandHelperView from './CommandHelperView';
import DHCPConfig from './DHCPConfig';
import DHCPRelayConfig from './DHCPRelayConfig';
import DHCPSnoopingConfig from './DHCPSnoopingConfig';
import VLANConfig from './VLANConfig';
import InterfaceConfig from './InterfaceConfig';
import LinkAggregationConfig from './LinkAggregationConfig';
import PortIsolationConfig from './PortIsolationConfig';
import StackingConfig from './StackingConfig';
import MLAGConfig from './MLAGConfig';
import STPConfig from './STPConfig';
import VRRPConfig from './VRRPConfig';
import WirelessConfig from './WirelessConfig';
import AdvancedWirelessConfig from './AdvancedWirelessConfig';
import RoutingConfig from './RoutingConfig';
import ConnectionConfig from './ConnectionConfig';
import ACLConfig from './ACLConfig';
// Fix: Use default import for NATConfig
import NATConfig from './NATConfig';
import SSHConfig from './SSHConfig';
import SecurityZoneConfig from './SecurityZoneConfig';
import SecurityPolicyConfig from './SecurityPolicyConfig';
import AddressGroupConfig from './AddressGroupConfig';
import ServiceGroupConfig from './ServiceGroupConfig';
import DomainGroupConfig from './DomainGroupConfig';
import IPsecConfig from './IPsecConfig';
import HAConfig from './HAConfig';
import GREVPNConfig from './GREVPNConfig';
                        ...
                        <div className="bg-slate-800 rounded-lg overflow-hidden">
                            ...
                            {expandedSections.l2Switching && (
                                <div className="p-2 space-y-2 border-t border-slate-700">
                                    ...
                                    {isFeatureApplicable('Stacking (IRF)', selectedNode.type) && (selectedNode.vendor === Vendor.H3C || selectedNode.vendor === Vendor.Huawei || selectedNode.vendor === Vendor.Cisco) && <StackingConfig selectedNode={selectedNode} onNodeUpdate={onNodeUpdate} isExpanded={expandedSections.stacking} onToggle={() => toggleSection('stacking')} onToggleFeature={() => handleToggleFeature('Stacking (IRF)')} isGenerating={generatingFeatures.has('Stacking (IRF)')} />}
                                    {isFeatureApplicable('M-LAG', selectedNode.type) && (selectedNode.vendor === Vendor.H3C || selectedNode.vendor === Vendor.Huawei) && <MLAGConfig selectedNode={selectedNode} onNodeUpdate={onNodeUpdate} isExpanded={expandedSections.mlag} onToggle={() => toggleSection('mlag')} onToggleFeature={() => handleToggleFeature('M-LAG')} isGenerating={generatingFeatures.has('M-LAG')} />}
