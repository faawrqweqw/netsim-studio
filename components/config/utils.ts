    ...
    if (config.mode === 'l3') {
        ...
        switch (vendor) {
            case Vendor.Cisco:
                ...
                if (deviceType === DeviceType.AC) cli += ` spanning-tree portfast\n`;
                break;
            case Vendor.Huawei:
                cli += ` port link-type access\n port default vlan ${vlanId}\n`;
                if (deviceType === DeviceType.AC) cli += ` stp edged-port enable\n`;
                break;
            case Vendor.H3C:
                cli += ` port access vlan ${vlanId}\n`;
                if (deviceType === DeviceType.AC) cli += ` stp edge-port\n`;
                break;
        }
        ...
        switch (vendor) {
            case Vendor.Cisco:
                ...
                if (deviceType === DeviceType.AC) cli += ` spanning-tree portfast trunk\n`;
                break;
            case Vendor.Huawei:
