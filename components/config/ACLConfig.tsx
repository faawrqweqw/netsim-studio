...
import { Node, ACL, ACLBasicRule, ACLAdvancedRule, TimeRange, TimeRangeDaySelection, Vendor } from '../../types';
...
const TimeRangeManagerModal = ({ timeRanges, selectedNode, onNodeUpdate, onClose }: { timeRanges: TimeRange[], selectedNode: Node, onNodeUpdate: (node: Node) => void, onClose: () => void }) => {
