...
const WirelessConfig: React.FC<WirelessConfigProps> = ({ selectedNode, isExpanded, onToggle, onToggleFeature, onOpenModal, isGenerating }) => {
                        ...
                        <p className="text-xs text-slate-500 italic">
                            {
                                ...
                                !isH3C ? "Wireless configuration is only available for H3C Access Controllers." :
