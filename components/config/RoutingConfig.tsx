...
const RoutingConfig: React.FC<RoutingConfigProps> = ({
    ...
    const updateOSPFArea = useCallback((index: number, updates: any) => {
        ...
        // FIX: Compare string to string, not string to number. The updates.areaId is a string from an input field, so comparing it to the number 0 is incorrect.
                                ...
                                <div className="border-t border-slate-600 p-3 space-y-3">
                                    ...
                                    <div className="space-y-2 pt-2 border-t border-slate-700">
                                        ...
                                        {routingConfig.ospf.areas.map((area, areaIndex) => {
                                            // FIX: Compare string to string, not string to number. area.areaId is a string.
