...
export const stpRules = [
  // Global mode
  {
    ...
    conversions: {
      ...
      [Vendor.H3C]: (_: string[], n?: any) => `stp mode ${n?.mode}`,
    },
  },
  ...
  // Interface features
  {
    ...
    conversions: { [Vendor.Cisco]: 'spanning-tree portfast', [Vendor.H3C]: 'stp edged-port enable' },
  },
  {
    pattern: 'stp bpdu-protection',
    explanation: '启用BPDU防护（等同于Cisco BPDU Guard）。',
    conversions: { [Vendor.Cisco]: 'spanning-tree bpduguard enable', [Vendor.H3C]: 'stp bpdu-protection' },
  },
];
