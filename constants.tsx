...
import { DeviceType, Vendor, Port, LinkConfig, NATConfig, SecurityConfig, ObjectGroupConfig, IPsecConfig, HAConfig, GREVPNConfig, StackingConfig, LinkAggregationMember, DHCPRelayConfig, DHCPSnoopingConfig } from './types';
import {
  RouterIcon,
  L3SwitchIcon,
  L2SwitchIcon,
