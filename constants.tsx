...
export const TOOLBAR_ITEMS = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: '信号塔', type: DeviceType.SignalTower, icon: <SignalTowerIcon className="w-full h-full text-orange-400" />, color: 'border-orange-400' },
      { name: 'Cloud', type: DeviceType.Cloud, icon: <CloudIcon className="w-full h-full text-orange-400" />, color: 'border-orange-400' },
    ]
  },
  {
    title: '无线设备',
    ...
    groups: [
      {
        ...
        preemptDelay: '30',
        timeout: 'slow',
        huaweiLacpPriorityMode: 'default',
      }
    ],
    cli: '',
    explanation: ''
...
const DEVICE_PORT_COUNTS: Partial<Record<DeviceType, number>> = {
  ...
  [DeviceType.AP]: 1,
  [DeviceType.AC]: 12,
  [DeviceType.SignalTower]: 1,
  [DeviceType.Text]: 0,
  [DeviceType.Rectangle]: 0,
  [DeviceType.Circle]: 0,
  [DeviceType.Halo]: 0,
  [DeviceType.Cloud]: 512,
};
