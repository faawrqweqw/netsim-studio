...
app.post('/api/ping', async (req: express.Request, res: express.Response) => {
...
// FIX: Use Request and Response types from 'express' to fix type errors.
// FIX: Use express.Request and express.Response to ensure correct types are used.
app.get('/api/inspection/templates/:vendor', async (req: express.Request, res: express.Response) => {
...
// FIX: Use Request and Response types from 'express' to fix type errors.
// FIX: Use express.Request and express.Response to ensure correct types are used.
app.get('/api/inspection/history/:deviceId', (req: express.Request, res: express.Response) => {
...
// FIX: Use Request and Response types from 'express' to fix type errors.
// FIX: Use express.Request and express.Response to ensure correct types are used.
app.post('/api/inspect', (req: express.Request, res: express.Response) => {
                        ...
                        stream.on('data', (data: Buffer) => {
                            ...
                            while (buffer.includes(marker)) {
                                ...
                                if (finishedCommandInfo && finishedCommandInfo.category !== '_setup') {
                                    ...
                                    finalResults[category][command] = cleanedOutput || 'No output returned.';
...
// FIX: Use Request and Response types from 'express' to fix type errors.
// FIX: Use express.Request and express.Response to ensure correct types are used.
app.post('/api/ssh/connect', (req: express.Request, res: express.Response) => {
    try {
...
// FIX: Use Request and Response types from 'express' to fix type errors.
// FIX: Use express.Request and express.Response to ensure correct types are used.
app.get('/api/ssh/stream/:sessionId', (req: express.Request, res: express.Response) => {
...
// FIX: Use Request and Response types from 'express' to fix type errors.
// FIX: Use express.Request and express.Response to ensure correct types are used.
app.post('/api/ssh/input/:sessionId', (req: express.Request, res: express.Response) => {
    const { sessionId } = req.params;
...
// FIX: Use Request and Response types from 'express' to fix type errors.
// FIX: Use express.Request and express.Response to ensure correct types are used.
app.post('/api/ssh/disconnect', (req: express.Request, res: express.Response) => {
