import { LinkAggregationConfig, Vendor } from '../../types';

export const generateLinkAggregationCli = (vendor: string, deviceType: string, config: LinkAggregationConfig): { cli: string; explanation: string } => {
